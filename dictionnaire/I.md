...
Chaîne de caractère émise par quelqu'un souhaitant recevoir un paiement sur le réseau Lightning et encodant les détails nécessaires à l'exécution du paiement par l'émetteur.
